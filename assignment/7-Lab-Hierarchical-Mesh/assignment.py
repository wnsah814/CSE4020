...
def main():
    ...
    arm = Node(base, glm.translate((0.25,0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    hand = Node(arm, glm.translate((0.25,0,.02)) * glm.scale((.25,.1,0.)), glm.vec3(0,1,0))
    # hand = Node(arm, glm.translate(.5, 0, .01), glm.vec3(0,1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        hand.set_transform(glm.translate((0.5, 0, 0)) * glm.rotate(t, (0,0,1)))
        ...
        draw_node(vao_box, hand, P*V, MVP_loc_box, color_loc_box)
