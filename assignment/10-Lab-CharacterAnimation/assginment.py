...
def main():
    ...
    arm_red1 = Node(base, glm.translate(glm.vec3(.2,0,0)), glm.translate((.25, 0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))
    arm_red2 = Node(base, glm.translate(glm.vec3(-.2,0,0)), glm.translate((-.25, 0,.01)) * glm.scale((.25,.1,0.)), glm.vec3(1,0,0))

    arm_green1 = Node(arm_red1, glm.translate(glm.vec3(.5,  0, 0.02)), glm.translate((.25, 0, 0.02)) * glm.scale((.25, .1, 0.)), glm.vec3(0, 1, 0))
    arm_green2 = Node(arm_red2, glm.translate(glm.vec3(-.5, 0, 0.02)), glm.translate((-.25, 0, 0.02)) * glm.scale((.25, .1, 0.)), glm.vec3(0, 1,0))
    # arm_green1 = Node(arm_red1, glm.translate(glm.vec3(.2,0,0)), glm.translate((.5,0,.01)) * glm.scale((.5,.1,0.)), glm.vec3(0, 1,0))
    # arm_green2 = Node(arm_red2, glm.translate(glm.vec3(-.2,0,0)), glm.translate((.5,0,.01)) * glm.scale((.5,.1,0.)), glm.vec3(0, 1,0))
    ...
    while not glfwWindowShouldClose(window):
        ...
        arm_red1.set_joint_transform(glm.rotate(t, (0,0,1)))
        arm_red2.set_joint_transform(glm.rotate(-t, (0,0,1)))
        arm_green1.set_joint_transform(glm.rotate(t, (0,0,1)))
        arm_green2.set_joint_transform(glm.rotate(-t, (0,0,1)))
        ...
        draw_node(vao_box, arm_red1, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, arm_red2, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, arm_green1, P*V, MVP_loc_box, color_loc_box)
        draw_node(vao_box, arm_green2, P*V, MVP_loc_box, color_loc_box)
