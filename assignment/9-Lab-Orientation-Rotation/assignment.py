    ...
    if key==GLFW_KEY_ESCAPE and action==GLFW_PRESS:
        ...
        if action==GLFW_PRESS or action==GLFW_REPEAT:
            if key==GLFW_KEY_1:
                ...
                angles.x += glm.radians(10)
            elif key==GLFW_KEY_Z:
                angles.x -= glm.radians(10)

            elif key==GLFW_KEY_S:
                angles.y += glm.radians(10)
            elif key==GLFW_KEY_X:
                angles.y -= glm.radians(10)

            elif key==GLFW_KEY_D:
                angles.z += glm.radians(10)
            elif key==GLFW_KEY_C:
                angles.z -= glm.radians(10)
...
def main():
    ...
    unif_names = ['MVP', 'M', 'view_pos', 'material_color', 'angles']
    unif_locs_lighting = {}
    ...
    while not glfwWindowShouldClose(window):
        ...
        M = glm.mat4(Rz1 * Rx * Rz2) # ZXZ Euler Angle
